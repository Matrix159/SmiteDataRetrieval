...
/**
 * Created by Eldridge on 4/2/2016.
 */
...
public class RankedConquest {
     ...
     * @param Trend
     */
    public RankedConquest(int Leaves, int Losses, String Name, int Points, int PrevRank, int Rank, Object Rank_Stat_Conquest, Object Rank_Stat_Duel, Object Rank_Stat_Joust, int Season, int Tier, int Trend, int Wins, Object player_id, Object ret_msg) {
        this.Leaves = Leaves;
        this.Losses = Losses;
        this.Name = Name;
        this.Points = Points;
